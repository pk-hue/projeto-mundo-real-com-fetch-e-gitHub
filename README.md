...
Essa é a minha solução para o desafio API Github.
...
Nesse projeto foi possível por em prática em especial algumas tecnologias de javacript, sendo assim possível criar um layout responsivo para ambos tipos de aparelhos e navegadores, possibilitando o usuário pesquisar perfis de outros usuários do github com dados como, avartar, seguidores, repositorios, eventos e etc.  
